...
export default async function RepoOverviewPage({ params }: RepoOverviewProps) {
  try {
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Structured list of modules and components
                  </p>
                </div>
                <div className="divide-y divide-gray-200 dark:divide-gray-700">
                  {visualFiles.index.length > 0 ? (
                    visualFiles.index.map((module, index) => (
                      <Link 
                        key={index}
                        href={`/${params.repo}/module/${encodeURIComponent(module.name)}`}
